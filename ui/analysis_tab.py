...
class AnalysisTabWidget(QWidget):
    ...
    def _connect_signals(self) -> None:
        ...
        self._type_combo.currentTextChanged.connect(self._schedule_analysis)
    ...
    def _run_analysis(self) -> None:
        ...
        self._worker.request_analysis(analysis, self._fs, self._signals, channels)
    ...
    def _replot(self) -> None:
        ...
        self._plot_widget.plot(result, x_unit, y_unit, log_x, log_y)
